...
function clicou(n) {
    ...
    if (elNumero !== null) {
        ...
        if (elNumero.nextElementSibling !== null) {
            ...
            elNumero.nextElementSibling.classList.add('pisca'); //Acha o Próximo elemento o elemento que está do lado.
...
function confirma() {
    ...
    if (votoConfirmado) {
        ...
        if (etapas[etapaAtual] !== undefined) {
            ...
            document.querySelector('.telaUrna').innerHTML = '<div class="aviso--gigante pisca">FIM</div>';
        }
    }
}
comecarEtapa();